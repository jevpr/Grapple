...
ROOT_URLCONF = 'EnglishLearning.EnglishLearning.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                "learning.context_processors.user_group_context",
            ],
        },
    },
]

WSGI_APPLICATION = 'EnglishLearning.EnglishLearning.wsgi.application'
